...
config :hierarchy_pai, HierarchyPaiWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: HierarchyPaiWeb.ErrorHTML, json: HierarchyPaiWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: HierarchyPai.PubSub,
  live_view: [signing_salt: "4Yk8Iwtl"]
...
config :hierarchy_pai, HierarchyPai.Mailer, adapter: Swoosh.Adapters.Local
